...
usage() {
  cat <<'EOF'
Usage: sudo kiosk-backlight-install-tools

Installs/updates kiosk-backlight tool scripts and runtime binary:
  - /usr/local/bin command scripts
  - /etc/kiosk-backlight.env (if missing)
  - /etc/kiosk-backlight-install.env (install metadata)
EOF
}
...
install -m 0755 "$SOURCE_REPO_DIR/tools/kiosk-backlight-install-tools.sh" /usr/local/bin/kiosk-backlight-install-tools
install -m 0755 "$SOURCE_REPO_DIR/tools/kiosk-backlight-uninstall-tools.sh" /usr/local/bin/kiosk-backlight-uninstall-tools
...
echo "[install-tools] Commands installed in /usr/local/bin:"
echo "  kiosk-backlight.sh"
echo "  kiosk-backlight-check-update"
echo "  kiosk-backlight-update"
echo "  kiosk-backlight-install-service"
echo "  kiosk-backlight-uninstall-service"
echo "  kiosk-backlight-install-tools"
echo "  kiosk-backlight-uninstall-tools"
echo "[install-tools] Next step:"
